        ...
        console.log('Enter into function');
            executequery("select * from election_parties",function(result)
            {
                ...
                res.write('<style>');
                    ...
                    res.write('.header{width: 1348px;width: 100%;height: 70px;background: #fff;background-color: #187ed2;color: #000;top: 0%;position: relative;}');
                ...
                res.write('<body>');
                res.write('<div class="header"><img src="/views/evote2.jpg" class="img"><h2>VoterID - '+ voterid1 + '     Name - ' + name +'</h2></div>')
